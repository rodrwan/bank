...
func (x *GetUserAccountRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GetUserAccountRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *GetUserAccountRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
type GetUserAccountResponse struct {
	...
	User    *User             `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`
	Account *accounts.Account `protobuf:"bytes,2,opt,name=account,proto3" json:"account,omitempty"`
}
...
func (x *GetUserAccountResponse) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *GetUserAccountResponse) GetAccount() *accounts.Account {
	if x != nil {
		return x.Account
	}
	return nil
...
var file_users_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x52, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x32, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55,
	...
	0x73, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x59, 0x0a, 0x15,
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x66, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x55, 0x73,
	...
	0x65, 0x72, 0x12, 0x2b, 0x0a, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x2e, 0x41,
	...
	0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x94, 0x02, 0x0a, 0x04,
	...
	0x41, 0x74, 0x32, 0x9f, 0x01, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x61, 0x64,
	...
	0x65, 0x22, 0x00, 0x12, 0x4f, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x41, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1c, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x47, 0x65,
	...
	0x73, 0x65, 0x22, 0x00, 0x32, 0x58, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x73, 0x57, 0x72, 0x69,
	0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x43, 0x0a, 0x0a, 0x43, 0x72, 0x65,
	...
	0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x6f, 0x64,
	0x72, 0x77, 0x61, 0x6e, 0x2f, 0x62, 0x61, 0x6e, 0x6b, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62,
...
var file_users_proto_goTypes = []interface{}{
	...
	(*GetUserAccountRequest)(nil),  // 2: users.GetUserAccountRequest
	(*GetUserAccountResponse)(nil), // 3: users.GetUserAccountResponse
	(*CreateUserRequest)(nil),      // 4: users.CreateUserRequest
	(*CreateUserResponse)(nil),     // 5: users.CreateUserResponse
	(*User)(nil),                   // 6: users.User
	(*accounts.Account)(nil),       // 7: accounts.Account
	(*timestamp.Timestamp)(nil),    // 8: google.protobuf.Timestamp
}
var file_users_proto_depIdxs = []int32{
	6, // 0: users.GetUserResponse.user:type_name -> users.User
	6, // 1: users.GetUserAccountResponse.user:type_name -> users.User
	7, // 2: users.GetUserAccountResponse.account:type_name -> accounts.Account
	6, // 3: users.CreateUserRequest.user:type_name -> users.User
	8, // 4: users.User.created_at:type_name -> google.protobuf.Timestamp
	8, // 5: users.User.update_at:type_name -> google.protobuf.Timestamp
	0, // 6: users.UsersReadService.GetUser:input_type -> users.GetUserRequest
	2, // 7: users.UsersReadService.GetUserAccount:input_type -> users.GetUserAccountRequest
	4, // 8: users.UsersWriteService.CreateUser:input_type -> users.CreateUserRequest
	1, // 9: users.UsersReadService.GetUser:output_type -> users.GetUserResponse
	3, // 10: users.UsersReadService.GetUserAccount:output_type -> users.GetUserAccountResponse
	5, // 11: users.UsersWriteService.CreateUser:output_type -> users.CreateUserResponse
